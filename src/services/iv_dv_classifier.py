...
_DV_PATTERNS: List[Tuple[re.Pattern, str, float, DVAccessLevel, DVMeasurementType]] = [
    ...
    (re.compile(r'\bcortisol\b', re.I),
     "physio.cortisol", 0.95, DVAccessLevel.NEUROENDOCRINE, DVMeasurementType.PHYSIOLOGICAL),
    ...
    # EEG sub-bands (Wave 9 — V10 #6 Neuroscientist decomposition)
    (re.compile(r'alpha\s*(?:power|band|oscillat)', re.I),
     "neural.eeg.alpha_power", 0.92, DVAccessLevel.NEURAL, DVMeasurementType.NEUROIMAGING),
    (re.compile(r'alpha\s*asymmetr|frontal\s*alpha', re.I),
     "neural.eeg.alpha_asymmetry", 0.92, DVAccessLevel.NEURAL, DVMeasurementType.NEUROIMAGING),
    (re.compile(r'theta\s*(?:power|band|oscillat)|frontal\s*midline\s*theta', re.I),
     "neural.eeg.theta_power", 0.92, DVAccessLevel.NEURAL, DVMeasurementType.NEUROIMAGING),
    (re.compile(r'beta\s*(?:power|band|oscillat)', re.I),
     "neural.eeg.beta_power", 0.92, DVAccessLevel.NEURAL, DVMeasurementType.NEUROIMAGING),
    (re.compile(r'gamma\s*(?:power|band|oscillat)', re.I),
     "neural.eeg.gamma_power", 0.92, DVAccessLevel.NEURAL, DVMeasurementType.NEUROIMAGING),
    (re.compile(r'\bEEG\b|brain\s*wave|alpha\s*wave', re.I),
     "neural.eeg", 0.88, DVAccessLevel.NEURAL, DVMeasurementType.NEUROIMAGING),
