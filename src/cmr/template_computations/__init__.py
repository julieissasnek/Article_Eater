...
8. NMC1 - Natural Material Convergence
...
# =============================================================================
# NMC1: NATURAL MATERIAL CONVERGENCE
# =============================================================================

# Channel weights from NMC1 calibration_parameters.wood_channel_weights
NMC1_WOOD_WEIGHTS = {
...
# Non-wood material profiles from NMC1 calibration
NMC1_MATERIAL_PROFILES = {
    "wood": NMC1_WOOD_WEIGHTS,
    "stone": {
        "visual": 0.35,
        "haptic_thermal": 0.30,
        "acoustic": 0.20,
...
def compute_nmc1_material_convergence(
    ...
    """
    NMC1: Natural Material Stress Reduction via Multi-Modal Convergence.
    ...
    """
    if material_type not in NMC1_MATERIAL_PROFILES:
        raise ValueError(f"Unknown material type: {material_type}")

    if not 0 <= surface_ratio <= 1:
        raise ValueError("Surface ratio must be between 0 and 1")

    profile = NMC1_MATERIAL_PROFILES[material_type]
    ...
    return ComputeResult(
        ...
        confidence=0.70,  # NMC1 maturity: preliminary for non-wood
        details={
...
TEMPLATE_COMPUTE_FUNCTIONS = {
    ...
    "NMC1": compute_nmc1_material_convergence,
