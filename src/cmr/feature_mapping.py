...
STANDARD_BUILDING_FEATURES = {
    ...
    "calibration_context",
    "context_type",
    # Added during CREA-I / L2 / MAT4 integrations:
    "daylight_exposure_hours",
    "natural_material_ratio",
    "has_daylight_variation",
    "has_designed_dynamics",
    "static_exposure_hours",
    "change_rate_hz",
    "baseline_creativity",
    "climate_context",
    "ventilation_type",
    "dynamic_content",
    "acoustic_intrusions_per_day",
    "acoustic_snr_db",
    "actual_distance_cm",
    ...
    "cue_congruence",
    "curvature_ratio",
    "distraction_free_ratio",
    "distraction_rate_per_hour",
    "dominant_hue",
    "environmental_novelty_score",
    "exploration_access",
    "exposure_duration_min",
    "external_memory_support_score",
    "functional_scent_match",
    "group_size",
    "haptic_material",
    "iaq_co2_ppm",
    "is_enclosed_niche",
    ...
    "light_lux",
    "material_change",
    "material_scent_match",
    "monotony_days",
    "motion_disorientation_events",
    "night_noise_dba",
    "novelty_density",
    "path_has_nature",
    "pe_variation",
    ...
    "sound_change",
    "spatial_change",
    "spatial_nesting_levels",
    "spatial_sequence_clarity",
    "spectral_slope",
    "spectral_slope_alpha",
    "thermal_discomfort_events_per_day",
    "thermal_material",
    "time_pressure",
    "transition_frequency",
    "unisensory_strength_avg",
    "unpredictability_index",
    "vertical_transition_count",
    "vestibular_cue_quality",
    "view_type",
    "visual_access_grid",
    "visual_material",
    "walk_duration_min",
    "wayfinding_error_rate",
    "working_memory_load",
    "zone_type",
    # Intermediate scores used by composite templates (e.g. L3)
    "l1_score",
    "l2_score",
    "l4_score",
    "l5_score",
